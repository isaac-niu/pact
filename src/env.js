...
export const env = {
  ...
  SOLANA_CLUSTER: getViteEnv("SOLANA_CLUSTER") || "devnet",
  SOLANA_RPC: getViteEnv("SOLANA_RPC") || "",
  SOLANA_ESCROW_TREASURY: getViteEnv("SOLANA_ESCROW_TREASURY") || "",
  SOLANA_ALLOW_MAINNET: getViteEnv("SOLANA_ALLOW_MAINNET") || "",
};
