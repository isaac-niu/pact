...
/**
 * Determine if MongoDB Atlas is configured.
 * Used by the server to decide between Atlas and in-memory fallback.
 */
export function mongoConfigReady() {
  return !!(process.env.MONGODB_URI && process.env.MONGODB_DB_NAME);
}
 ...
 * Returns "pact" as default when not configured.
 */
export function getMongoDbName() {
  return process.env.MONGODB_DB_NAME ?? "pact";
}
